...
<div class="flex min-h-screen flex-col items-center justify-center px-4 bg-surface">
	<div class="w-full max-w-sm">
		<h1 class="mb-2 text-h1 text-text-primary">Iniciar sesión</h1>
		<p class="mb-8 text-body text-text-secondary">
			Accede a tu cuenta para gestionar tus impresiones
		</p>
		...
		<p class="mt-6 text-center text-body-small text-text-secondary">
			¿No tienes cuenta?
			<a href="/auth/register" class="text-accent hover:text-accent-hover hover:underline">
				Crear cuenta
			</a>
		</p>
	</div>
